...
- [-] 2.6 Display staff notes section
- [ ] 2.7 Display banking details (Director only)
- [ ] 2.8 Add Approve button with confirmation
- [ ] 2.9 Add Reject button with reason input
- [ ] 2.10 Add Request Info button
- [ ] 2.11 Add Note input field
- [ ] 2.12 Add Share Link button
- [ ] 2.13 Add Export PDF button
