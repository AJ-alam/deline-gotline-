...
class API {
    ...
    // Log banking details access (Director only - Requirement 12.3)
    static logBankingDetailsAccess(submissionId: number): Promise<any> {
        return apiClient.post(`/forms/submissions/${submissionId}/log-banking-access/`, {});
    }
}
